...
_asyncToGenerator(function* () {
	...
	chrome.tabs.query({ active: true, lastFocusedWindow: true }, (() => {
		var _ref2 = _asyncToGenerator(function* (tabs) {
			...
			const isDefaultWhiteListed = Object(__WEBPACK_IMPORTED_MODULE_1__utils__["k" /* isDomainInList */])(host, whitelist.sites.def);
			const isWhiteListed = Object(__WEBPACK_IMPORTED_MODULE_1__utils__["k" /* isDomainInList */])(host, whitelist.sites.all);
	...
	$('#report-over').on('click', function () {
		...
		__WEBPACK_IMPORTED_MODULE_2__PBStorage_PBStorageSync__["a" /* default */].pb_detectOverlays.get().then((() => {
			var _ref3 = _asyncToGenerator(function* (isActive) {
				const isFFP = yield Object(__WEBPACK_IMPORTED_MODULE_1__utils__["l" /* isFireFoxIncognito */])();

				if (isActive) {
					if (!isFFP) {
						Object(__WEBPACK_IMPORTED_MODULE_1__utils__["p" /* sendToActiveTab */])('manual-remove-overlay', { source: 'menu' });
					} else {
						Object(__WEBPACK_IMPORTED_MODULE_1__utils__["p" /* sendToActiveTab */])('overlay-not-active-incognito', { source: 'menu' });
					}
				} else {
					Object(__WEBPACK_IMPORTED_MODULE_1__utils__["p" /* sendToActiveTab */])('overlay-not-active', { source: 'menu' });
				}
