...
/* harmony default export */ __webpack_exports__["a"] = (function (pop) {
  ...
  __WEBPACK_IMPORTED_MODULE_5__PBStorage_PBStorageSync__["a" /* default */].all.update(settings => {
    ...
    //user is updated but never had a GPRD flag before, lets show him
        ...
        if (!settings.pb_OneTimeEvents.Welcome && Object(__WEBPACK_IMPORTED_MODULE_8__utils__["f" /* getBrowser */])() == 'FF') {
          settings.pb_OneTimeEvents.Welcome = true;
          settings.pb_detectOverlays = false;
  ...
  chrome.contextMenus.onClicked.addListener((() => {
    var _ref = _asyncToGenerator(function* (info, tab) {
      const isFFP = yield Object(__WEBPACK_IMPORTED_MODULE_8__utils__["l" /* isFireFoxIncognito */])();
      ...
      if (info.menuItemId == "removeOL") {
        if (Settings.pb_detectOverlays) {
          if (!isFFP) {
            ...
            Object(__WEBPACK_IMPORTED_MODULE_8__utils__["p" /* sendToActiveTab */])('overlay-not-active-incognito', { source: 'right-click' });
          }
        } else {
          Object(__WEBPACK_IMPORTED_MODULE_8__utils__["p" /* sendToActiveTab */])('overlay-not-active', { source: 'right-click' });
        }
...
class BadgeManager {
	...
	setBadge(tab) {
		try {
			Object(__WEBPACK_IMPORTED_MODULE_1__utils__["j" /* getTodayBlockCount */])(__WEBPACK_IMPORTED_MODULE_0__PBStorage_PBStorageSync__["a" /* default */], new URL(tab.url).host, function (count) {
