...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__PBStorage_PBStorageSync__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__const__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__utils__ = __webpack_require__(1);
function _asyncToGenerator(fn) { return function () { var gen = fn.apply(this, arguments); return new Promise(function (resolve, reject) { function step(key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { return Promise.resolve(value).then(function (value) { step("next", value); }, function (err) { step("throw", err); }); } } return step("next"); }); }; }
...
(() => {
  var _ref = _asyncToGenerator(function* ($) {
    const tabUrl = yield Object(__WEBPACK_IMPORTED_MODULE_9__utils__["i" /* getTabUrl */])();

    const pbMessage = Object(__WEBPACK_IMPORTED_MODULE_9__utils__["o" /* randId */])();
    ...
    function showNotSupportedPopup(options) {
      notification.addQueue({
        ...
        subTitle: '<div class="overlay-not-supported">' + Object(__WEBPACK_IMPORTED_MODULE_9__utils__["g" /* getI18N */])('NTF_OVERLAY_INACTIVE_MESSAGE') + '</div>',
    ...
    function initBlockFunctions() {
      __WEBPACK_IMPORTED_MODULE_7__PBStorage_PBStorageSync__["a" /* default */].many(__WEBPACK_IMPORTED_MODULE_7__PBStorage_PBStorageSync__["a" /* default */].pb_hideBadge, __WEBPACK_IMPORTED_MODULE_7__PBStorage_PBStorageSync__["a" /* default */].pb_overlaylist, __WEBPACK_IMPORTED_MODULE_7__PBStorage_PBStorageSync__["a" /* default */].pb_pause, __WEBPACK_IMPORTED_MODULE_7__PBStorage_PBStorageSync__["a" /* default */].pb_popupBlackList).get().then((() => {
        var _ref2 = _asyncToGenerator(function* (settings) {
          ...
          if (!Object(__WEBPACK_IMPORTED_MODULE_9__utils__["k" /* isDomainInList */])(tabUrl.domain, whitelist.sites.all)) {
            let code = `(function () {
      ...
      if (chrome.runtime.getURL('').indexOf(event.origin) == 0 && event.data.toastId == this.toastId) {
        ...
        switch (data.action) {
          ...
          case 'pb-message-tooltip-over':
            if (Object(__WEBPACK_IMPORTED_MODULE_2__utils__["m" /* isI18N */])(data.id)) {
